...
type HelloReply struct {
	...
	Result        []*HelloReply_Result   `protobuf:"bytes,2,rep,name=result,proto3" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HelloReply) GetResult() []*HelloReply_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
const file_hello_proto_rawDesc = "" +
	...
	"\x06result\x18\x02 \x03(\v2\x18.proto.HelloReply.ResultR\x06result\x1a.\n" +
	"\x06Result\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url2i\n" +
	"\aGreeter\x122\n" +
	"\bSayHello\x12\x13.proto.HelloRequest\x1a\x11.proto.HelloReply\x12*\n" +
	"\x04Ping\x12\x16.google.protobuf.Empty\x1a\n" +
	".base.PongB\tZ\a.;protob\x06proto3"
...
var file_hello_proto_goTypes = []any{
	...
	(*HelloReply_Result)(nil), // 2: proto.HelloReply.Result
	(*emptypb.Empty)(nil),     // 3: google.protobuf.Empty
	(*Pong)(nil),              // 4: base.Pong
}
var file_hello_proto_depIdxs = []int32{
	2, // 0: proto.HelloReply.result:type_name -> proto.HelloReply.Result
	0, // 1: proto.Greeter.SayHello:input_type -> proto.HelloRequest
	3, // 2: proto.Greeter.Ping:input_type -> google.protobuf.Empty
	1, // 3: proto.Greeter.SayHello:output_type -> proto.HelloReply
	4, // 4: proto.Greeter.Ping:output_type -> base.Pong
